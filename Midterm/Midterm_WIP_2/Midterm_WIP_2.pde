...
AudioPlayer guitar;
 ...
 Arnold = minim.loadFile("Y2Mate.is - Hey Arnold  Ending theme.-Xd6aV5eW-GM-128k-1648479610473.mp3");
...
/* strokeWeight(4);
  ...
  */ 
  fill(0);
    rect(300, 0, 20, 300);
    textSize(23);
    text("Hit a number key from ", 160, 500); 
        text("1 to 4", 250, 530); 

        textSize(20);
    text("Music Changer by Elijah Moyd", 150, 550); 
